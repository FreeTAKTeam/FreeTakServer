...
class AtakOfTheCerts:
    def __init__(self, pwd: str = config.password) -> None:
        ...
        self.key = rsa.generate_private_key(65537, 4096, None)
        self.CERTPWD = pwd
    ...
    def generate_ca(self, expiry_time_secs: int = 31536000) -> None:
        ...
        ca_private_key = rsa.generate_private_key(65537, 4096, None)
        ca_public_key = ca_private_key.public_key() # might not be needed, generated by the cert. 
        # cert = crypto.X509()
        import datetime 
