...
FTS_VERSION = "FreeTAKServer-2.0.4 Alpha"
API_VERSION = "1.9.5"
...
class MainConfig:
    ...
    def validate_and_sanitize_path(self, path):
        ...
        if not os.access(sanitized_path, os.F_OK) or not os.access(sanitized_path, os.W_OK) or not os.path.exists(sanitized_path):
            raise ValueError
