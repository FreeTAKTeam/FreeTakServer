...
from companion_parrot.configuration.companion_parrot_constants import CONFIGURATION_PATH_TEMPLATE
from .. import domain
...
class CompanionParrotDomain(Domain):
#protectedend ######################################################################################




	"""This class is to be used for all interactions with the Companion Parrot
