...
class CompanionParrotFacade(DefaultFacade):
#protectedend ######################################################################################
...
#protectedend ######################################################################################
		...
		self.companion_connects_to_master = CompanionParrotGeneralController()
		self.companion_subscribe = CompanionParrotGeneralController()
