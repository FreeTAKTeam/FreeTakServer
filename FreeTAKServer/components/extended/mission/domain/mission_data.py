...
class MissionData(CoTNode):
    def __init__(self, configuration, model, oid=None):
        ...
        self.cot_attributes["ownerRole"] = None
    ...
    def defaultRole(self):
        return self.cot_attributes.get("MissionRoleDefault")
    
    @defaultRole.setter
    def defaultRole(self, defaultRole=None):
        self.cot_attributes["MissionRoleDefault"] = defaultRole
    
    @CoTProperty
    def ownerRole(self):
        return self.cot_attributes.get("MissionRoleOwner")
    
    @ownerRole.setter
    def ownerRole(self, ownerRole=None):
        self.cot_attributes["MissionRoleOwner"] = ownerRole

    @CoTProperty
    def token(self):
        return self.cot_attributes.get("token")
