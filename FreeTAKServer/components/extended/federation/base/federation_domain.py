...
from federation.configuration.federation_constants import CONFIGURATION_PATH_TEMPLATE
from .. import domain
...
class FederationDomain(Domain):
#protectedend ######################################################################################




	"""This class is to be used for all interactions with the Federation
