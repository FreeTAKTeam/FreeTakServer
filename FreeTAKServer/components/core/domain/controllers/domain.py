...
class Domain(Controller):
    ...
    def create_node(self, configuration: Configuration, object_class_name: str, registry: registry, id:str=str(uuid.uuid1()), **kwargs) -> None:
        ...
        object_class_instance = object_class(configuration, self.domain, registry, oid=oid)
