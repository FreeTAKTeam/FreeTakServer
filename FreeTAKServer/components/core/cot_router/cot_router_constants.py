...
LOGGING_CONFIGURATION_PATH = pathlib.PurePath(CURRENT_COMPONENT_PATH, 'configuration/logging.conf')

ACTION_MAPPING_PATH = pathlib.PurePath(CURRENT_COMPONENT_PATH, 'configuration/cot_router_action_mapping.ini')
