...
class Orchestrator(ABC):
    ...
    def __init__(self):
        # TODO Move to own controller or class
        ...
        # Is there a limit here in connections?
    ...
    def mainRunFunction(
            self,
            clientData: pool.AsyncResult,
            receiveConnection: pool.AsyncResult,
            sock: socket,
            pool: pool.ThreadPool,
            event: multiprocessing.Event,
            clientDataPipe: Queue,
            ReceiveConnectionKillSwitch: multiprocessing.Event,
            CoTSharePipe, 
            ssl=False
        ):
