...
class MainConfig:
    ...
    _defaults = {
        ...
        'ExCheckChecklistFilePath': {'default': Path(fr'{PERSISTENCE_PATH}/ExCheck/checklist'), 'type': str},
        'DataPackageFilePath': {'default': Path(fr'{PERSISTENCE_PATH}/FreeTAKServerDataPackageFolder'), 'type': str},
        'LogFilePath': {'default': Path(fr"{PERSISTENCE_PATH}/Logs"), 'type': str},
        'federationKeyPassword': {'default': 'defaultpass', 'type': str},
        'keyDir': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.key'), 'type': str},
        'pemDir': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.pem'), 'type': str},
        'testPem': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.key'), 'type': str},
        'testKey': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.pem'), 'type': str},
        'unencryptedKey': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.key.unencrypted'), 'type': str},
        'p12Dir': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.p12'), 'type': str},
        'CA': {'default': Path(fr'{PERSISTENCE_PATH}/certs/ca.pem'), 'type': str},
        'CAkey': {'default': Path(fr'{PERSISTENCE_PATH}/certs/ca.key'), 'type': str},
        'federationCert': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.pem'), 'type': str},
        'federationKey': {'default': Path(fr'{PERSISTENCE_PATH}/certs/server.key'), 'type': str},
        'federationKeyPassword': {'default': 'defaultpass', 'type': str},
        'password': {'default': 'supersecret', 'type': str},
        'websocketkey': {'default': "YourWebsocketKey", 'type': str},
        'CRLFile': {'default': Path(fr"{PERSISTENCE_PATH}/certs/FTS_CRL.json"), 'type': str},
