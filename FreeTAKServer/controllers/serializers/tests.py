...
class TestSerializers(unittest.TestCase):
    ...
    def test_xml_serialization(self):
        ...
        xmlstring = '<?xml version="1.0" encoding="UTF-8" standalone="yes"?><event version="2.0" uid="fb637afd-7d37-4d98-8def-839eee6aa4bc" type="b-i-v" time="2021-05-22T14:52:40.416Z" start="2021-05-22T14:52:40.416Z" stale="2021-05-22T15:52:40.416Z" how="m-g"><point lat="0.0" lon="0.0" hae="9999999.0" ce="9999999.0" le="9999999.0"/><detail><contact callsign="stream demo"/><link uid="fb637afd-7d37-4d98-8def-839eee6aa4bc" production_time="2021-05-22T14:52:40.416Z" relationship="p-p" parent_callsign="NOVA"/><__video><ConnectionEntry networkTimeout="0" uid="fb637afd-7d37-4d98-8def-839eee6aa4bc" path="/LiveApp/342508189321134315564775" protocol="rtmp" bufferTime="-1" address="138.197.129.27" port="1935" roverPort="-1" rtspReliable="0" ignoreEmbeddedKLV="false" alias="stream demo"/></__video><marti><dest callsign="FAST"/></marti></detail></event>'

        # fts_obj = XmlSerializer().from_format_to_fts_object(xmlstring, Event.GeoChat())
        fts_obj = XmlSerializer().from_format_to_fts_object(xmlstring, Event.VideoStream())
