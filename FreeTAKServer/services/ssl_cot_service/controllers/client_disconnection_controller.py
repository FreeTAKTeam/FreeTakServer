...
class ClientDisconnectionController(Controller):
    """ control the process of disconnecting a ssl client
    """
    ...
    def get_socks(self, client_information) -> Tuple[socket.socket, socket.socket]:
        ...
        if isinstance(client_information, str):
            ...
            return self.client_information_queue[client_information.clientInformation][0], self.client_information_queue[client_information.clientInformation][2]
        else:
